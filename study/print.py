...
# 为了理解python中的字典概念，请为我写一个运行代码示例，要有详细的代码示例以展现这些参量最大使用场景与最大功能，整合到一个代码示例中，且在控制台要清晰显示这些函数用法，要介绍其相关函数的必选与可选传入参量和给我代码示例。加上注释说明函数的作用，传入参量与注意事项，如有相关类似的函数可以补充说明其中的区别和加上代码示例

# 为了理解python中的Python 函数概念，参考以上文档，(文档可能有错误，仅参考，再给我比这个还正确，复杂的代码示例)可以比它更广更深，请为我写一个运行代码示例，要有详细的代码示例以展现这些参量最大使用场景与最大功能，整合到一个代码示例中，且在控制台要清晰显示这些函数用法，要介绍其相关函数的必选与可选传入参量和给我代码示例
